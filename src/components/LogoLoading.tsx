...
export default function LogoLoading() {
    ...
    // Initial server-side and first-client-render version
    // Must exactly match the structure to avoid hydration errors
    const staticContent = (
        ...
        <div className="relative flex flex-col items-center justify-center" suppressHydrationWarning>
            ...
            <div className="mt-12 flex flex-col items-center gap-3">
                ...
                <motion.div
                    ...
                    initial={{ opacity: 0 }}
                    animate={isMounted ? { opacity: [0.3, 1, 0.3] } : { opacity: 0 }}
